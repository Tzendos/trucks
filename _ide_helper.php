 ...
 * Generated for Laravel 6.5.2 on 2019-11-26 13:31:01.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Queue {
        ...
        {
                        /** @var \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue $instance */
                        $instance->setCorrelationId($id);
        }
        
        /**
         * 
         *
         * @return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\AmqpContext 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function declareEverything($queueName = null)
        {
                        /** @var \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue $instance */
                        return $instance->declareEverything($queueName);
        }
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function json($data = array(), $status = 200, $headers = array(), $options = 2368)
        {
                        /** @var \App\Providers\ResponseFactory $instance */
        ...
        {
            //Method inherited from \Illuminate\Routing\ResponseFactory            
                        \App\Providers\ResponseFactory::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\ResponseFactory            
                        \App\Providers\ResponseFactory::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\ResponseFactory            
                        return \App\Providers\ResponseFactory::hasMacro($name);
        }
    ...
    class Route {
        ...
        {
                        return \App\Providers\Router::toResponse($request, $response);
        }
        ...
        public static function get($uri, $action = null)
        {
            //Method inherited from \Illuminate\Routing\Router            
                        /** @var \App\Providers\Router $instance */
        ...
        {
            //Method inherited from \Illuminate\Routing\Router            
                        \App\Providers\Router::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Router            
                        \App\Providers\Router::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Router            
                        return \App\Providers\Router::hasMacro($name);
        }
...
namespace  { 
    ...
    class RedisExt extends \Illuminate\Support\Facades\Redis {}
